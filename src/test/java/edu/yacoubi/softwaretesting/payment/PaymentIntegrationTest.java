...
import edu.yacoubi.softwaretesting.customer.CustomerRegistrationRequest;
...
public class PaymentIntegrationTest {
    ...
    // allows us to test the RestApi semantic
    @Autowired
                        ...
                        put("/api/v1/customer-registration")
                                ...
                                .content(
                                        Objects.requireNonNull(
                                                objectToJson(customerRegistrationRequest)
                                        )
                                )
                );
